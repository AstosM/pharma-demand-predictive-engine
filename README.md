...
│
├── Global Distribution State.png                    # Macro PBI Screenshot
├── Isolated Risk Constraints State.png              # Filtered PBI Screenshot
├── visual_dashboard.png                             # HTML UI Screenshot
├── visual_dashboard.html                            # Compiled high-contrast web dashboard layer
├── requirements.txt                                 # Application dependencies snapshot
└── Pharma_Project_Report.pdf                         # Executive Analytics & Model Validation Report
